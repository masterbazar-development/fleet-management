...
<!-- banner -->
<section class="relative bg-[url('./assets/images/safetyban.jpg')] bg-cover bg-center bg-no-repeat">
    ...
    <div class="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
      <div class="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
        ...
        Fleet safety and fleet
          <strong class="block font-extrabold text-white">safety management</strong>
          <strong class="block font-extrabold text-white"> solutions </strong>
          
        </h1>
  
        <p class="mt-4 max-w-lg sm:text-xl/relaxed text-sky-800 font-bold pt-5 pb-3">
  ...
  <!-- banner ends here -->
  <!-- first section -->
  <div class="containerpt-14 flex flex-col px-6 py-4 mx-auto space-y-6 md:h-128 md:py-16 md:flex-row md:items-center md:space-x-6">
  <div class="flex flex-col items-center w-full md:flex-row md:w-1/2">

      <div class="max-w-xl md:mx-12 md:order-2 w-full">
          <img class="object-cover w-full h-full max-w-2xl rounded-md" src="./assets/images/safety1.jpg" alt="">
      </div>
  </div>

  <div class="flex flex-col  justify-center w-full h-96 md:w-1/2 md:items-start">
      <h1 class="text-3xl font-bold tracking-wide text-sky-800 dark:text-white md:text-4xl pb-4">Commercial fleet insurance</h1>
      ...
      <div class="mt-6">
          <a href="#" class="flex items-center -mx-1 text-base text-sky-800  transition-colors duration-300 transform dark:text-blue-400 hover:underline hover:text-blue-600 dark:hover:text-blue-500">
              <span class="mx-1 underline text-lg">learn how to save a insurance with Fleet</span>
...
<div class="container  pt-14 flex flex-col px-6 py-4 mx-auto space-y-6 md:h-128 md:py-16 md:flex-row md:items-center md:space-x-6">
    <div class="flex flex-col items-center w-full md:flex-row md:w-1/2">
        ...
        <div class="max-w-xl md:mx-12 md:order-2">
            <h1 class="text-3xl font-bold tracking-wide text-sky-800 dark:text-white md:text-4xl pb-4">Fleet driver safety reporting</h1>
        <p class="mt-4 text-sky-800 dark:text-gray-300 text-lg">Geotab helps keep drivers, vehicles, unpowered assets — and ultimately, roadways — safe. Our powerful data-driven fleet safety solutions keep safety at the forefront.</p>
        <p class="mt-4 text-sky-800 dark:text-gray-300 text-lg">Our system uses high-resolution accelerometer data to help you monitor key fleet safety metrics — like harsh braking incidents — and eliminate false positives and negatives to accurately capture driver behavior. </p>
        <p class="mt-4 text-sky-800 dark:text-gray-300 text-lg">Plus, with MyGeotab safety dashboard reports, custom fleet safety alerts, advanced collision avoidance systems, and more, you'll get to know your drivers — and their driving habits — to better promote safety within your fleet. </p>
        
        <div class="mt-6">
            <a href="#" class="flex items-center -mx-1 text-base text-sky-800  transition-colors duration-300 transform dark:text-blue-400 hover:underline hover:text-blue-600 dark:hover:text-blue-500">
                <span class="mx-1 underline text-lg">learn more about driver safety reporting</span>
                <svg class="w-4 h-4 mx-1 rtl:-scale-x-100" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
            </a>
        </div>
    ...
    <div class="flex flex-col  justify-center w-full h-96 md:w-1/2 md:items-start">
        <img class="object-cover w-full h-full max-w-2xl rounded-md" src="./assets/images/safety2.jpg" alt="">
    </div>
</div>
<!-- third section -->
<div class="containerpt-14 flex flex-col px-6 py-4 mx-auto space-y-6 md:h-128 md:py-16 md:flex-row md:items-center md:space-x-6">
  <div class="flex flex-col items-center w-full md:flex-row md:w-1/2">
      ...
      <div class="max-w-xl md:mx-12 md:order-2 w-full">
          <img class="object-cover w-full h-full max-w-2xl rounded-md" src="./assets/images/safety3.jpg" alt="">
      </div>
  </div>

  <div class="flex flex-col  justify-center w-full h-96 md:w-1/2 md:items-start">
      <h1 class="text-3xl font-bold tracking-wide text-sky-800 dark:text-white md:text-4xl pb-4">Driver coaching</h1>
      <p class="mt-4 text-sky-800 dark:text-gray-300 text-lg">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aut quia asperiores alias vero magnam recusandae adipisci ad vitae laudantium quod rem voluptatem eos accusantium cumque.</p>
      ...
      <div class="mt-6">
          <a href="#" class="flex items-center -mx-1 text-base text-sky-800  transition-colors duration-300 transform dark:text-blue-400 hover:underline hover:text-blue-600 dark:hover:text-blue-500">
              <span class="mx-1 underline text-lg">learn more about driver coaching</span>
              <svg class="w-4 h-4 mx-1 rtl:-scale-x-100" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
          </a>
      </div>
  </div>
...
<section class=" bg-slate-200">
        <div class="xl:flex max-w-7xl mx-auto py-24">
            <div class="p-10 xl:w-1/3">
                <h2 class="text-4xl font-semibold text-[#25477B]">Fleet driver safety blog resources</h2>
                <p class="text-black mt-4 text-lg">Safety is everyone’s responsibility. Learn about our fleet safety management solutions that monitor driver behavior, along with dashboard reports, custom alerts and collision avoidance systems that can help keep your drivers — and everyone else — safe.</p>
            </div>
...
<div class="container  pt-14 flex flex-col px-6 py-4 mx-auto space-y-6 md:h-128 md:py-16 md:flex-row md:items-center md:space-x-6">
    <div class="flex flex-col items-center w-full md:flex-row md:w-1/2">
        ...
        <div class="max-w-xl md:mx-12 md:order-2">
            <h1 class="text-3xl font-bold tracking-wide text-sky-800 dark:text-white md:text-4xl pb-4">Dash cams</h1>
        <p class="mt-4 text-sky-800 dark:text-gray-300 text-lg">Take the guesswork out of collisions and other critical traffic events with our seamlessly integrated AI-powered dash camera solutions featuring advanced ADAS and DMS functionalities. Review HD footage and save video clips for later use as a valuable fleet safety training resource for your drivers.</p>
        
        <div class="mt-6">
            <a href="#" class="flex items-center -mx-1 text-base text-sky-800  transition-colors duration-300 transform dark:text-blue-400 hover:underline hover:text-blue-600 dark:hover:text-blue-500">
                <span class="mx-1 underline text-lg">learn more about fleet dash cams </span>
                <svg class="w-4 h-4 mx-1 rtl:-scale-x-100" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
            </a>
        </div>
    ...
    <div class="flex flex-col  justify-center w-full h-96 md:w-1/2 md:items-start">
        <img class="object-cover w-full h-full max-w-2xl rounded-md" src="./assets/images/safety4.jpg" alt="">
    </div>
</div>
...
Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorum nemo atque ut obcaecati, explicabo sapiente excepturi, aperiam ea unde temporibus voluptatem natus cum maxime.</p>
  ...
  style="background-image: url('./assets/images/newsletter1.jpg');">
    ...
    <div class="w-full text-center">
      ...
      <h2 class="mb-4 text-white text-3xl md:text-4xl font-extrabold">Ready to improve fleet safety? </h2>
