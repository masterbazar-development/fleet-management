...
<body>
<!-- banner -->
<section class="relative bg-[url('./assets/images/productivity1.jpg')] bg-cover bg-center bg-no-repeat">
    ...
    <div class="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
      <div class="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
        <h1 class="text-3xl font-extrabold sm:text-5xl text-white">
          Enhanced Fleet
          <strong class="block font-extrabold text-white"> Productivity For Optional </strong>
          <strong class="block font-extrabold text-white"> Operations</strong>
        </h1>
  ...
  <div class="container  pt-14 flex flex-col px-6 py-4 mx-auto space-y-6 md:h-128 md:py-16 md:flex-row md:items-center md:space-x-6">
    <div class="flex flex-col items-center w-full md:flex-row md:w-1/2">
        ...
        <div class="max-w-xl md:mx-12 md:order-2">
            <h1 class="text-3xl font-bold tracking-wide text-sky-800 dark:text-white md:text-4xl pb-4">Driver Tracking</h1>
...
<div class="container  pt-14 flex flex-col px-6 py-4 mx-auto space-y-6 md:h-128 md:py-16 md:flex-row md:items-center md:space-x-6">
  ...
  <div class="flex flex-col  justify-center w-full h-96 md:w-1/2 md:items-start">
      <h1 class="text-3xl font-bold tracking-wide text-sky-800 dark:text-white md:text-4xl pb-4">Asset tracking and management</h1>
      <p class="mt-4 text-sky-800 dark:text-gray-300 text-lg">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aut quia asperiores alias vero magnam recusandae adipisci ad vitae laudantium quod rem voluptatem eos accusantium cumque.</p>
      <div class="mt-6">
          <a href="#" class="flex items-center -mx-1 text-base text-sky-800  transition-colors duration-300 transform dark:text-blue-400 hover:underline hover:text-blue-600 dark:hover:text-blue-500">
              <span class="mx-1 underline text-lg">learn more about asset tracking</span>
              <svg class="w-4 h-4 mx-1 rtl:-scale-x-100" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
          </a>
      </div>
  </div>
...
<div class="container  pt-14 flex flex-col px-6 py-4 mx-auto space-y-6 md:h-128 md:py-16 md:flex-row md:items-center md:space-x-6">
  <div class="flex flex-col items-center w-full md:flex-row md:w-1/2">
      ...
      <div class="max-w-xl md:mx-12 md:order-2">
          <h1 class="text-3xl font-bold tracking-wide text-sky-800 dark:text-white md:text-4xl pb-4">Routing and dispatching</h1>
      <p class="mt-4 text-sky-800 dark:text-gray-300 text-lg">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aut quia asperiores alias vero magnam recusandae adipisci ad vitae laudantium quod rem voluptatem eos accusantium cumque.</p>
      <div class="mt-6">
          <a href="#" class="flex items-center -mx-1 text-base text-sky-800  transition-colors duration-300 transform dark:text-blue-400 hover:underline hover:text-blue-600 dark:hover:text-blue-500">
              <span class="mx-1 underline text-lg">learn more about routing and dispatching</span>
              <svg class="w-4 h-4 mx-1 rtl:-scale-x-100" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
          </a>
      </div>
  ...
  <div class="flex flex-col  justify-center w-full h-96 md:w-1/2 md:items-start">
      <img class="object-cover w-full h-full max-w-2xl rounded-md" src="./assets/images/routing.jpg" alt="">
  </div>
</div>
...
<div class="container  pt-14 flex flex-col px-6 py-4 mx-auto space-y-6 md:h-128 md:py-16 md:flex-row md:items-center md:space-x-6">
  <div class="flex flex-col items-center w-full md:flex-row md:w-1/2">
      ...
      <div class="max-w-xl md:mx-12 md:order-2">
          <img class="object-cover w-full h-full max-w-2xl rounded-md" src="./assets/images/tools.jpg" alt="">
      </div>
  </div>

  <div class="flex flex-col  justify-center w-full h-96 md:w-1/2 md:items-start">
      <h1 class="text-3xl font-bold tracking-wide text-sky-800 dark:text-white md:text-4xl pb-4">Integrate fleet data into your business intelligence (BI) tool</h1>
      <p class="mt-4 text-sky-800 dark:text-gray-300 text-lg">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aut quia asperiores alias vero magnam recusandae adipisci ad vitae laudantium quod rem voluptatem eos accusantium cumque.</p>
      <div class="mt-6">
          <a href="#" class="flex items-center -mx-1 text-base text-sky-800  transition-colors duration-300 transform dark:text-blue-400 hover:underline hover:text-blue-600 dark:hover:text-blue-500">
              <span class="mx-1 underline text-lg">learn more about data connector</span>
              <svg class="w-4 h-4 mx-1 rtl:-scale-x-100" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
          </a>
      </div>
  </div>
...
<div class="container  pt-14 flex flex-col px-6 py-4 mx-auto space-y-6 md:h-128 md:py-16 md:flex-row md:items-center md:space-x-6">
  <div class="flex flex-col items-center w-full md:flex-row md:w-1/2">
      ...
      <div class="max-w-xl md:mx-12 md:order-2">
          <h1 class="text-3xl font-bold tracking-wide text-sky-800 dark:text-white md:text-4xl pb-4">Fleet management reports</h1>
      <p class="mt-4 text-sky-800 dark:text-gray-300 text-lg">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Aut quia asperiores alias vero magnam recusandae adipisci ad vitae laudantium quod rem voluptatem eos accusantium cumque.</p>
      <div class="mt-6">
          <a href="#" class="flex items-center -mx-1 text-base text-sky-800  transition-colors duration-300 transform dark:text-blue-400 hover:underline hover:text-blue-600 dark:hover:text-blue-500">
              <span class="mx-1 underline text-lg">learn more about fleet management reports</span>
              <svg class="w-4 h-4 mx-1 rtl:-scale-x-100" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M12.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-2.293-2.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
          </a>
      </div>
  ...
  <div class="flex flex-col  justify-center w-full h-96 md:w-1/2 md:items-start">
      <img class="object-cover w-full h-full max-w-2xl rounded-md" src="./assets/images/report.jpg" alt="">
  </div>
</div>
<!-- faqs -->
...
<div class="w-full p-5 pt-14">
  ...
  style="background-image: url('./assets/images/newsletter1.jpg');">
    ...
    <div class="w-full text-center">
      ...
      <h2 class="mb-4 text-white text-3xl md:text-5xl font-extrabold">Ready to boost our Fleet Productivity </h2>
