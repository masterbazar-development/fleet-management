...
<body>
    ...
    <section class="contactussec mt-10">
        <div class="max-w-7xl mx-auto flex py-32">
            <div class="xl:w-1/2 mx-[3vw] xl:mx-0">
                <h1 class="text-white text-4xl md:text-6xl font-semibold">Contact us</h1>
                <p class="text-white text-xl md:text-2xl w-3/4 mt-3">Choose one of the options below to get in touch with the right
                    person at Geotab.</p>
